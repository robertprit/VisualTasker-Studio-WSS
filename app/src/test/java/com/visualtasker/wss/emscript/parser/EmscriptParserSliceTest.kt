...
class EmscriptParserSliceTest {
    ...
    fun roundtrip_catalogCommands_surviveParserWorkspaceIrAndDryRun() {
        ...
        assertTrue(document.blocks.values.any { it.type == "${BlockTypes.EMSCRIPT_COMMAND_PREFIX}shizuku.systemService" })
        assertTrue(document.blocks.values.any { it.type == "${BlockTypes.EMSCRIPT_COMMAND_PREFIX}shizuku.call" })
        ...
        assertTrue(regenerated.contains("Shizuku.systemService(\"package\");"))
        assertTrue(regenerated.contains("Shizuku.call(\"package\",\"1\",[\"s16\",\"com.visualtasker.wss\"]);"))
